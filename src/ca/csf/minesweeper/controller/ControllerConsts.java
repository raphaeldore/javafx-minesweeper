...
final class ControllerConsts {
  ...
  public static final Image IMAGE_SMILE_WORRY = loadImage("Smile_Worry.png");

  private static Image loadImage(String path) {
    InputStream resource = ControllerConsts.class.getResourceAsStream(resourcesPath + path);
